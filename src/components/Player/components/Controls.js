      ...
      {/* <div class="Controls-box"> */}
          <div class="Controls-body">
            <div class="controls-left">
              <span className="skip-back" onClick={skipBack}><img src="./icons/Reload-backward.png"></img></span>

                
              <span className="prev" onClick={prevSong}><img src="./icons/Previous.png"></img></span>
            </div>
            ...
            <div class="controls-right">
              <span className="next" onClick={nextSong}><img src="./icons/Arrowsideright.png"></img></span>
              <span className="skip-forward" onClick={skipForward}><img src="./icons/Reload-backward.png"></img></span>
            </div>
